export default function Terms() {
    return (
        <>
            Termos de Uso e Serviço da Portfólio Dev Marcelo Andrade
            <br />
            Seja Bem-Vindo ao site da Portfólio Dev Marcelo Andrade. Antes de explorar tudo o que temos a oferecer, é importante que você entenda e concorde com algumas regras básicas que regem o uso do nosso site https://devmarceloandrade.com.br/, e qualquer outro serviço digital que nós oferecemos, como lojas e plataformas de e-commerce.
            <br />
            ...
            Se tiver dúvidas sobre estes termos, não hesite em nos contatar através do e-mail andradelm.dev@gmail.com.
        </>
    );
}